...
module Weather
  class AlertsForecaster < ApplicationService
    ...
    def call
      ...
      when "noaa"
          Noaa::Forecast::Alerts.(latitude, longitude)
      else "openweather"
         OpenWeather::Forecast::Alerts.new(latitude: latitude, longitude: longitude).call
      end
